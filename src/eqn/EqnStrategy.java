...
/**
 * The class EqnStrategy implements a PGMS strategy.
 ...
 */
public final class EqnStrategy implements Strategy {

  /*
   * The Equation Strategy associates a value with each point
  ...
  private void display_eqn_set(Set es) {
    ...
    public void play(Map m, RLController rlc) {
        System.out.println("EqnStrategy dont implement this method.");
    }
}
